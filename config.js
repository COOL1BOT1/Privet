...
module.exports = {
    ...
    WARN_MSG: process.env.WARN_MSG === undefined ? "Ok bye🥳" : process.env.WARN_MSG,
    ANTIJID: process.env.ANTIJID === undefined ? '' : process.env.ANTIJID,
    STICKER_PACKNAME: process.env.STICKER_PACKNAME === undefined ? 'IMASH.👼' : process.env.STICKER_PACKNAME,
